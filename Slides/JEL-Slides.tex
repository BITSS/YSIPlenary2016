...
{YSI Plenary, October 2016\\
Slides available online \url{http://www.github.com/BITSS/YSIPlenary2016}}
...
\item
Not something only evil people do. It's subconscious, or simply built into statistics (\href{http://www.stat.columbia.edu/~gelman/research/unpublished/p_hacking.pdf}{Gelman, Loken 2013}).
\end{itemize}
\end{frame}
...
\begin{enumerate}[<.->]
 \item The Problem	
 	...
 	\item \href{http://www.jstor.org/stable/1806061}{Replication Projects: JMCB}, \href{https://www.federalreserve.gov/econresdata/feds/2015/files/2015083pap.pdf}{Chang \& Li}, Camerer
	\end{itemize}
 ...
 { % all template changes are local to this group.
   \setbeamertemplate{navigation symbols}{}
    \begin{frame}[plain, label=AEAreg]
         \begin{tikzpicture}[remember picture,overlay]
            \node[at=(current page.center)] {
                \includegraphics[height=1.5in]{../Images/github-logo-transparent.JPG}
                 \includegraphics[width=2in]{../Images/RStudio-Logo-Blue-Gradient.png}			     			 \includegraphics[height=1.5in]{../Images/jupyter.png}   
            };
        \end{tikzpicture}
     \end{frame}
}
...
%    \begin{frame}[plain, label=AEAreg]
%         \begin{tikzpicture}[remember picture,overlay]
%            \node at (0,2) \includegraphics[height=1.5in]{../Images/github-logo-transparent.JPG};
                
%              \node[above] at (3,2) \includegraphics[width=2in]{../Images/RStudio-Logo-Blue-Gradient.png};
              
%              \node[above] at (1,1) \includegraphics[height=1.5in]{../Images/jupyter.png};   
%           \end{tikzpicture}
%     \end{frame}
%}
